...
def getHomeruns():
    ...
    for player in homerunLeaders:
        ...
        playerWeight = int(player['value']) / homerunAvg
...
def getRBIs():
    ...
    for player in rbiLeaders:
        playerName = player['name']
        playerWeight = int(player['value']) / rbiAvg
...
def getBattingAverage():
    ...
    for player in battingAverageLeaders:
        playerName = player['name']
        playerWeight = int(player['value']) / battingAverageAvg
...
def getAvg(leaders):
    ...
    for player in leaders:
        average += int(float(player['value']))
